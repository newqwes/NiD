...
let inicialState = {
    postData: [
        ...
        { id: 2, dateTime: "08 июля, 15:35", avatar: "https://cdn3.iconfinder.com/data/icons/avatars-round-flat/33/avat-01-512.png", name: "Азим", postText: "Дата последнего обновления, время поста!" }
    ],
    galaryPhotosData: [

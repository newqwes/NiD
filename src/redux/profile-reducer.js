...
let inicialState = {
    postData: [
        ...
        { id: 2, dateTime: "16 июля, 00:42", avatar: "https://cdn3.iconfinder.com/data/icons/avatars-round-flat/33/avat-01-512.png", name: "Назар", postText: "Дата последнего обновления, время поста!" }
    ],
    galaryPhotosData: [
